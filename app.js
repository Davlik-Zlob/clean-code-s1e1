...
var taskInput=document.querySelectorAll(".list__input")[0];//Add a new task.
var addButton=document.getElementsByTagName("button")[0];//first button
var incompleteTaskHolder=document.getElementById("tasks_incomplete");//ul of #tasks_incomplete
var completedTasksHolder=document.querySelector(".tasks_completed");//tasks_completed
var titleAdd=document.querySelectorAll('.title')[0];

titleAdd.addEventListener('click', () => {
  taskInput.focus();
})
...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="list__input list__input_edit";
...
var addTask=function(){
    ...
    //Create a new list item with the text from the #tasks_new:
